...
const Testimonials: FunctionComponent = () => {
  ...
  return (
    ...
    >
      <h2
        className="text-2xl md:text-3xl relative z-10 lg:text-[56px] text-iconColor font-semibold font-monserat md:text-center md:w-[80%] lg:w-[70%] mx-auto leading-[120%] tracking-[1px]"
        data-aos="fade-up"
      >
        What Did They
